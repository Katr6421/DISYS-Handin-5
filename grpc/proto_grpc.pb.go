...
type AuctionClient interface {
	...
	SendID(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*IdAnswer, error)
}
...
func (c *auctionClient) SendID(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*IdAnswer, error) {
	out := new(IdAnswer)
	err := c.cc.Invoke(ctx, "/simpleGuide.Auction/SendID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuctionServer interface {
	...
	SendID(context.Context, *IdRequest) (*IdAnswer, error)
...
func (UnimplementedAuctionServer) SendID(context.Context, *IdRequest) (*IdAnswer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendID not implemented")
}
...
func _Auction_SendID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuctionServer).SendID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/simpleGuide.Auction/SendID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionServer).SendID(ctx, req.(*IdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auction_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SendID",
			Handler:    _Auction_SendID_Handler,
		},
	},
